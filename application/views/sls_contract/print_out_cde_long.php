			...
			<tr>
				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_2"] == null) {
											echo "Maksimum kapasitas muatan unit kendaraan CDE Long = 2 Ton / 8 CBM.";
										} else {
								...
								<tr>
									<td valign="top"><?php if ($rs_data[0]["informasi_lain"]!="") { echo '12'; }else { echo '11';}?>.</td><td>Tarif kontrak berlaku sampai dengan <?php echo $rs_data[0]["cvp"]; ?> bulan terhitung dari tanggal efektif <?php echo format_date($rs_data[0]["tanggal"]); ?>.</td>
								</tr>
