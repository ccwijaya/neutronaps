			...
			<tr>
				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_1"] == null) {
											echo "Tarif pengiriman barang adalah Free On Truck (FOT) dan atau tidak termasuk biaya bongkar muat barang";
										} else {
								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_2"] == null) {
											echo "Maksimum kapasitas muatan unit kendaraan CDE Standar = 2 Ton / 5.5 CBM.";
										} else {
								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_3"] == null) {
											echo " Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 2 Ton, maka dikenakan biaya Rp.350,- / Kg.";
										} else {
								...
								<tr>
									<td valign="top">4.</td><td>Pemilik Barang wajib mengasuransikan barang kiriman.</td>
								</tr>
								<tr>
								...
								<tr>
									<td valign="top">8.</td><td>Tarif pengiriman barang dapat ditinjau kembali jika terjadi perubahan kebijakan peraturan pemerintah.</td>
								</tr>
								...
								<tr>
									<td valign="top"><?php if ($rs_data[0]["informasi_lain"]!="") { echo '12'; }else { echo '11';}?>.</td><td>Tarif kontrak barang berlaku sampai dengan <?php echo $rs_data[0]["cvp"]; ?> bulan terhitung dari tanggal efektif <?php echo format_date($rs_data[0]["tanggal"]); ?>.</td>
								</tr>
