...
$id_sales = "";
$id_cabang = "";
$no_contract = "-- AUTO NUMBER --";
$tanggal_contract = date("Y-m-d");
$id_customer = "";
$keterangan = "";
//$status_proses_q = "";
//$status_approve_q = "";
...
if($results != ""){							
	foreach($results as $result){
		...
		$tanggal_contract = $result["tanggal_contract"];
		//}else{
			//$tanggal_contract = $tanggal_contract;
		//}
	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
				<h4 class="lighter">
					<button class="btn btn-primary radius-4" onclick="javascript:$('.submit').click();" <?php //if($is_contract==1){echo"disabled";}?> >
					...
					<!-- <?php //if($id!=""){ ?>
						...
						<i class="ace-icon fa fa-print "></i><?php if($status_approve_q !=1){ echo 'Waiting Approve'; } else { echo 'Print Contract';}?>
					</a>
					<?php //} ?> -->
				
					<?php if($no_contract!=""){ ?>
							<?php if($tc_moda==1){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_40_ft/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==2){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_20_ft/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==3){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==4){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_fuso/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==5){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_cdd_long/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==6){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_cdd_std/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==7){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_cde_long/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==8){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_cde_std/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==9){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_minibox/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==10){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_40_ft_ff/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
							<?php if($tc_moda==11){ ?>
								<a class="btn btn-purple radius-4" target="_blank" href="<?php echo site_url();?><?php echo $class_name;?>/print_out_20_ft_ff/?id=<?php echo $id;?>"><i class="ace-icon fa fa-print "></i>Print Contract</a>
							<?php }?>
					<?php }?>										
				</h4>
									...
									<div class="tabbable">
										...
										<div id="tab1" class="tab-pane fade in active">
												<div class="col-md-offset-0">
													...
													echo texthidden("is_contract", 1);
													//echo texthidden("no_contract", $no_contract);
													...
													echo '<label>No. Contract</label>';
													$param["name"] = "no_contract";
													//$param["class_column"] = "col-lg-12";
													$param["readonly"] = "Y";
													$param["value"] = $no_contract;
													echo textbox($param);
													unset($param);
													echo '</div>';

													echo'<div class="col-xs-12 col-sm-2">';
													echo '<label>Contract Date</label>';
													$param["name"] = "tanggal_contract";
													$param["class_column"] = "col-xs-12";
													$param["required"] = "Y";
													$param["value"] = format_date($tanggal_contract);
												...
												<div class="row">
													<div class="col-xs-12 col-sm-2">
														<label>Attachment Contract Sign</label>
													...
													echo'<div class="col-xs-12 col-sm-2">';
													echo '<label>Contract Validity Period (Month)</label>';
													$param["name"] = "cvp";
													$param["class_column"] = "col-xs-12";
													$param["required"] = "Y";
													$param["value"] = $cvp;
															...
															<p>
																...
																<table id="list_detail" class="table table-striped table-bordered table-hover" width=100%>
																	...
																	foreach($rs_detail_pnl as $result){
																		...
																		print '<td>' . numericbox_detail2("tarif_nego_".$i, "tarif_nego[]", format_number($result["tarif_nego"])) . '</td>';
