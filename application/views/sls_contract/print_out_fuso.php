								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_2"] == null) {
											echo "Maksimum kapasitas muatan unit kendaraan Fuso Bak/Box = 10 Ton / 30 CBM.";
										} else {
								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_3"] == null) {
											echo " Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 10 Ton, maka dikenakan biaya Rp.450,- / Kg.";
										} else {
