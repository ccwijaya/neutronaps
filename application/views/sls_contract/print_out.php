			...
			<tr>
				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								...
								<tr>
									<td valign="top"><?php if ($rs_data[0]["informasi_lain"]!="") { echo '11'; }else { echo '10';}?>.</td><td>Tarif kontrak berlaku sampai dengan <?php echo $rs_data[0]["cvp"]; ?> bulan terhitung dari tanggal efektif <?php echo format_date($rs_data[0]["tanggal"]); ?>.</td>
								</tr>
