		...
		<table width=100%>
			...
			<tr>
				...
				<td width=50% valign="top" style="padding-right:50px;">
					<div class="quotation">CONTRACT</div>
						<table class="data_header">
							<tr>
								<td>Date</td>
								<td>:</td>
								<td><?php echo format_date($rs_data[0]["tanggal_contract"]); ?></td>
							</tr>
							<!-- <tr>
								<td>Your REF</td>
								<td>:</td>
							...
							<tr>
								<td>No. Contract</td>
								<td>:</td>
								<td><?php echo $rs_data[0]["no_contract"]; ?></td>
							</tr>
							...
							<tr>
								...
								<td>:</td>
								<td><?php echo format_date($rs_data[0]["tanggal_contract"]); ?><?php //echo date('d M y'); ?></td>
							</tr>
							<!-- <tr>
								<td>T.O.P</td>
								<td>:</td>
			...
			<tr>
				...
				<table border=0 width=30% class="">
						...
						<tr>
							...
							<tr>
									<td valign="top">4. </td><td>Tarif yang tercantum diatas sudah termasuk biaya asuransi. Ketentuan klaim pada asuransi mengikuti dengan klausal yang berlaku, diantaranya apabila terjadi kerusakan dan atau kehilangan pada objek pengiriman yang disebabkan oleh pihak transporter dan dapat dibuktikan selama masa pengiriman maka untuk klaim kerugian tersebut pihak customer wajib mengikuti ketentuan / prosedur yang diberlakukan perusahaan asuransi tersebut.</td>
								</tr>
								<tr>
									<td valign="top">5. </td><td>Permintaan unit container Door to Door wajib diinformasikan maksimal H-7 kepada PIC <?php echo ($rs_data[0]["contact_admin"]); ?> dan DI CC kepada <?php echo ($rs_data[0]["nama_sales"]); ?> Email: <?php echo ($rs_data[0]["email_sales"]); ?>, No. HP: <?php echo ($rs_data[0]["no_wa"]); ?>.</td>
								</tr>

								<tr>
									<td valign="top">6. </td><td>Ketentuan pembayaran adalah 50% sebelum barang dimuat dan 50% sisa pelunasan setelah 14 Hari invoice diterima.</td>
								</tr>

								<tr>
								
									<td valign="top">7. </td><td>Muatan wajib mengikuti segala bentuk ketentuan berat dan dimensi container yang dipesan.</td>
								</tr>
								
								<tr>
									<td valign="top">8. </td><td>Biaya cancelation fee akan dikenakan sebesar 50% dari tarif yang berlaku apabila terjadi pembatalan jika pengiriman tersebut sudah dibooking kepada pihak pelayaran.</td>
								</tr>

								<tr>
									<td valign="top">9. </td><td>Tarif kontrak barang berlaku sampai dengan <?php echo $rs_data[0]["cvp"]; ?> bulan terhitung dari tanggal efektif <?php echo format_date($rs_data[0]["tanggal"]); ?>.</td>
								</tr>
								
								
								
								<tr>
									<td>10. </td><td>Pembayaran transfer ke Bank:</td>
								</tr>
								<tr>
