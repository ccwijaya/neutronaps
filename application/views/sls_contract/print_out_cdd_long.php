								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_2"] == null) {
											echo "Maksimum kapasitas muatan unit kendaraan CDD Long = 8 Ton / 15 CBM.";
										} else {
								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_3"] == null) {
											echo " Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 8 Ton, maka dikenakan biaya Rp.350,- / Kg.";
										} else {
