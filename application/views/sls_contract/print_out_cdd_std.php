			...
			<tr>
				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_2"] == null) {
											echo "Maksimum kapasitas muatan unit kendaraan CDD Standar = 5 Ton / 12 CBM.";
										} else {
								...
								<tr>
									...
									<td>
										<?php if ($rs_data[0]["edit_tc_3"] == null) {
											echo " Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 5 Ton, maka dikenakan biaya Rp.350,- / Kg.";
										} else {
								...
								<tr>
									<td valign="top"><?php if ($rs_data[0]["informasi_lain"]!="") { echo '11'; }else { echo '10';}?>.</td><td>Tarif kontrak barang berlaku sampai dengan <?php echo $rs_data[0]["cvp"]; ?> bulan terhitung dari tanggal efektif <?php echo format_date($rs_data[0]["tanggal"]); ?>.</td>
								</tr>
