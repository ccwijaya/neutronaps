							...
							<div class="tabbable">
								<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
									...
									<li class="">
										...
										<!-- <li <?php if($global_akses_harga_jual==0){ echo'class="hidden"';}else{echo'';}?>>
											<a data-toggle="#" href="#">
											GL Distribution
											</a>
										</li>
										...
										<form method="post" id="formlist" action="">
											...
											<table id="listdata" class="table table-striped table-bordered table-hover" width="100%">
													...
													foreach($results as $result){                                
														...
														print '<td align="center">' . $result["nama_sales"] . '</td>';
														print '<td align="center">' . $result["nama_cabang"] . '</td>';
														//print '<td>' . ($result["periode"]) . '</td>';
														//print '<td align="right"> Rp.' . format_number($result["tarif"]) . '</td>';
														print '<td align="center">' . ($result["keterangan"]) . '</td>';
