			...
			<div class="row">
				<div class="col-xs-12">
					<h4 class="lighter">
						...
						<button class="btn btn-warning radius-4" onclick="location.href='<?php echo site_url();?><?php echo $class_name;?>';"disabled>
						...
						<div class="col-xs-12">
							<div class="tabbable">
								...
								<div class="tab-content">
									...
									<tbody>
									<?php
									foreach($rs_request as $result){                                
										print '<tr>';										
										print '<td>' . ($result["no_bukti"]) . '</td>';
										print '<td>' . format_date($result["tanggal"]) . '</td>';
										print '<td>' . ($result["kode"]) . '</td>';
										print '<td>' . ($result["nama_customer"]) . '</td>';
										//print '<td>' . ($result["no_bukti"]) . '</td>';
										//print '<td>' . ($result["notif_to_inv"]) . '</td>';
										print '<td class="">
												<a target="" class="btn btn-xs btn-purple" href="' . site_url() . $class_name . '/entry/?id_ps=' . $result["id"] . '">Create Inquiry</a>
											</td>';
										print '</tr>';
									}								
									?>
