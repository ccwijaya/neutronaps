...
if($results != ""){							
	foreach($results as $result){
		$id = $result["id"];
		$kode_jasa_detail = $result["kode_jasa_detail"];
		$nama_jasa = $result["nama_jasa"];
									...
									<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab">
										...
										<div class="tab-content">
											...
											<div id="tab1" class="tab-pane fade  in active col-md-offset-3">
												...
												$param["name"] = "kode_jasa_detail";
												//$param["class_column"] = "col-lg-5";
												$param["required"] = "Y";
												$param["value"] = $kode_jasa_detail;
												echo textbox2($param);
												unset($param);
												echo '</div>';

												echo'<div class="col-xs-12 col-sm-2">';
												echo '<label>Nama Jasa</label>';
												$param["name"] = "nama_jasa";
												//$param["class_column"] = "col-lg-5";
												$param["required"] = "Y";
												$param["value"] = $nama_jasa;
												echo textbox2($param);
												unset($param);
												echo '</div>';
