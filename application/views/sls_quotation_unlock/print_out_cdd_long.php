				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								...
								<tr>
									...
									<td valign="top">2.</td><td>Maksimum kapasitas muatan unit kendaraan CDD Long = 8 Ton & 15 CBM.</td>
								</tr>
								<tr>
								
									<td valign="top">3.</td><td>Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 8 Ton, maka dikenakan biaya Rp.250,000,- / 1 Ton.</td>
								</tr>
								<tr>
								...
								<tr>
									<td></td><td>a) Biaya Overnight hari pertama dikenakan biaya sebesar Rp.<?php echo format_number($rs_data[0]["biaya_overnight_mid"]) ?>,-.</td>
								</tr>
								<tr>
