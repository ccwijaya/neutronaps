				...
				<div class="col-xs-12">
					<h4 class="lighter">
						<button class="btn btn-primary radius-4" onclick="javascript:$('.submit').click();" disabled>
							<i class="ace-icon fa fa-key bigger-160"></i>Unlock
						</button>
										...
										//if($result["ready_quote_retail"]==""){
											if($result["selisih"]>7){
												if($result["waktu_approved_q"]!=""){
													...
													print '<a target="" class="btn btn-danger" href="' . site_url() . $class_name . '/entry/?id=' . $result["id"] . '"><i class="ace-icon fa fa-lock"></i></a>';
												}
											}
											if($result["selisih"]<7){
												//if($result["is_deal"]==1){
													print '<a target="" class="btn btn-info" href="' . site_url() . $class_name . '/entry/?id=' . $result["id"] . '"><i class="ace-icon fa fa-unlock"></i></a>';
												//}else{
													//print '<label target="" class="btn btn-info" href=""><i class="ace-icon fa fa-lock"></i></label>';
												//}
											}
												print '&nbsp;';
											if($global_delete==1){
