				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								...
								<tr>
									...
									<td valign="top">2.</td><td>Maksimum kapasitas muatan unit kendaraan CDE Standar = 2 Ton & 5.5 CBM.</td>
								</tr>
								<tr>
								
									<td valign="top">3.</td><td>Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 2 Ton, maka dikenakan biaya Rp.250,000,- / 1 Ton.</td>
								</tr>
								<tr>
								...
								<tr>
									<td></td><td>a) Biaya Overnight hari pertama dikenakan biaya sebesar <?php echo ($rs_data[0]["biaya_overnight_mid"]) ?>,-.</td>
								</tr>
								<tr>
