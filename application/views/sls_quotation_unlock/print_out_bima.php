				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								...
								<tr>
									...
									<td valign="top">2.</td><td>Maksimum kapasitas muatan unit kendaraan Tronton Wingbox = 25 Ton & 53 CBM.</td>
								</tr>
								<tr>
								
									<td valign="top">3.</td><td>Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 25 Ton, maka dikenakan biaya Rp.350,000,- / 1 Ton.</td>
								</tr>
								<tr>
								...
								<tr>
									<td valign="top">7.</td><td>Jangka waktu pelunasan tagihan (TOP) adalah 
									<?php 
									if($rs_data[0]["cash"]==1){ 
										echo "2 Hari";
									}
								...
								<tr>
									<td valign="top">9.</td><td>Biaya pembatalan unit  armada apabila unit armada  sudah dalam perjalanan maupun tiba dilokasi muat akan dikenakan denda Sebesar 50% dari tarif pengiriman.</td>
								</tr>
								...
								<tr>
									<td><?php if ($rs_data[0]["informasi_lain"]!="") { echo '13'; }else { echo '12';}?>.</td><td>Pembayaran transfer ke Bank:</td>
								</tr>
								<tr>
