			...
			<tr>
				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								<tr>
									<td valign="top">1.</td><td>Tarif pengiriman barang adalah Free On Truck  (FOT) dan sudah termasuk biaya bongkar muat barang.</td>	
								</tr>
								<tr>
									
									<td valign="top">2.</td><td>Maksimum kapasitas muatan unit kendaraan CDD Standar = 5 Ton & 12 CBM.</td>
								</tr>
								<tr>
								
									<td valign="top">3.</td><td>Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 5 Ton, maka dikenakan biaya Rp.250,000,- / 1 Ton.</td>
								</tr>
								<tr>
								...
								<tr>
									<td></td><td>a) Biaya Overnight hari pertama dikenakan biaya sebesar Rp.350,000<?php //echo format_date($rs_data[0]["biaya_overnight_mid"]) ?>,-.</td>
								</tr>
								<tr>
								...
								<?php 
								$total_dalam_kota = $rs_data[0]["biaya_multidrop_dalam_mid"];
								$total_luar_kota = $rs_data[0]["biaya_multidrop_luar_mid"];
								...
								<tr>
									<td><?php if ($rs_data[0]["informasi_lain"]!="") { echo '14'; }else { echo '13';}?>.</td><td>Tarif pengiriman barang dapat ditinjau kembali jika terjadi perubahan kebijakan pemerintah (UMK, Harga BBM, Tarif Tol, Standarisasi Kapasitas Muatan Kendaraan / ODOL)</td>
								</tr>
