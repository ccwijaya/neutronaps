									...
									<div class="tabbable">
										...
										<div id="tab1" class="tab-pane fade in active">
												<div class="col-md-offset-2">
													...
													echo'<div class="row">';
													echo'<div class="col-xs-12 col-sm-3">';
													echo '<label>No. Berita Acara</label>';
													$param["name"] = "id_ba";
													//$param["class_column"] = "col-lg-5";
													$param["placeholder"] = "--Pilih Berita Acara--";
													$param["required"] = "Y";
													$param["value"] = $id_ba;
													$options["0"] = "--Pilih Berita Acara--";
													foreach ($rs_ba as $data) {
													...
													echo'<div class="col-xs-12 col-sm-3">';
													echo '<label>PPN</label>';
													$param["name"] = "ppn";
													//$param["class_column"] = "col-lg-5";
													$param["placeholder"] = "--Pilih Jenis PPN	--";
													$param["required"] = "Y";
													$param["value"] = $ppn;
													$options["0"] = "--Pilih Jenis PPN--";
													$options["1"] = "Ya";
													$options["2"] = "Tidak";
													$param["options"] = $options;
													echo combobox($param);
	...
	$("#id_ba").chosen().change(function(){
		$(this).find('option:selected').each(function(){
			...
			$.ajax({
				type: "GET",
				async: false,
				url: "<?php echo base_url(); ?>" + "sls_invoice/get_ba_detail_by_id",			
				data: {id: id},
				dataType: 'json',
	...
	$("#id_customer").chosen().change(function(){
		$(this).find('option:selected').each(function(){
			...
			$.ajax({
				type: "GET",
				async: false,
				url: "<?php echo base_url(); ?>" + "/sls_invoice/get_pelanggan_by_id",			
				data: {id: id},
				dataType: 'json',
				success: function(res) {
					console.log("RES : " + res);
