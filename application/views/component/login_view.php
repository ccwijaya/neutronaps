				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="center">
								<h1>									
								<img class="nav-user-photo" src="<?php echo base_url();?><?php echo get_folder_template();?>images/avatars/pbl.png"/ width="100">
								</h1>
								<h3 class="green" id="id-company-text"><b><?php echo get_company_name();?></b></h3>
								<h5 class="red" id="id-company-text"><b>FUMIGATION MANAGEMENT SYSTEM</b></h5>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="social-or-login center">
												<span class="bigger-100">Website:</span>
											</div>

											<div class="space-6"></div>

											<div class="social-login center">
											<a href="https://pbl.co.id">https://pbl.co.id</a>
											</div> -->
										</div><!-- /.widget-main -->
									</div><!-- /.widget-body -->
								</div><!-- /.login-box -->
