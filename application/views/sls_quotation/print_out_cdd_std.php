			...
			<tr>
				...
				<table border=0 width=30% class="">
						...
						<tr>
							...
							<tr>
									<td valign="top">4.</td><td>Pemilik barang wajib mengansurasikan barang, selama masa pegiriman pihak pengangkut barang tidak bertanggung jawab atas kerusakan, dan atau kehilangan barang akibat kecelakaan, perampokan, pencurian serta kerusakan yang diakibatkan force majeure.</td>
								</tr>
								...
								<tr>
									<td valign="top"><?php if ($rs_data[0]["informasi_lain"]!="") { echo '11'; }else { echo '10';}?>.</td><td>Tarif pengiriman barang berlaku sampai dengan 7 hari kerja terhitung dari tanggal efektif <?php echo format_date($rs_data[0]["tanggal"]); ?>.</td>
								</tr>
					...
					<table border=0 width=100% class="">
						...
						<tr><td align="center"><?php echo ($rs_data[0]["jabatan"]); ?></td></tr>
