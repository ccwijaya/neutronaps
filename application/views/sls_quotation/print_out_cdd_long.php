				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
							...
							<tr>
								...
								<tr>
									<td valign="top"><?php if ($rs_data[0]["informasi_lain"]!="") { echo '12'; }else { echo '11';}?>.</td><td>Tarif pengiriman barang berlaku sampai dengan 7 hari kerja terhitung dari tanggal efektif <?php echo format_date($rs_data[0]["tanggal"]); ?>.</td>
								</tr>
