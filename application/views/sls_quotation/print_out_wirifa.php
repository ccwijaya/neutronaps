	...
	?>
		<table class="table_detail" width=100%>
			...
			<tr>
				...
				<td class="leftright2" align="right">Rp.<?php echo format_number($result["tarif_pbl"]); ?> / Kg</td>
			...
			<tr>
				...
				<table border=0 width=30% class="">
						...
						<table border=0 width=95% class="">
								...
								<tr>
									<td valign="top">2.</td><td>Penghitungan biaya dalam setiap pengiriman minimal 25 Ton.</td>
								</tr>
								<!-- <tr>
								
									<td valign="top">3.</td><td>Setiap pengiriman barang yang melebihi batas maksimal kapasitas muatan 25 Ton.</td>
								</tr> -->
								<tr>
								
									<td valign="top">3</td><td>Permintaan unit armada pengiriman diinformasikan H-1 kepada PIC <?php echo ($rs_data[0]["contact_admin"]); ?> dan DI CC kepada <?php echo ($rs_data[0]["nama_sales"]); ?> Email: <?php echo ($rs_data[0]["email_sales"]); ?>, No. HP: <?php echo ($rs_data[0]["no_wa"]); ?>.</td>
								</tr>
								...
								<tr>
									<td></td><td>a) Dalam Kota Rp.<?php echo format_number($total_dalam_kota) ?>,- / Titik &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;b) Luar Kota Rp.<?php echo format_number($total_luar_kota) ?>,- / Titik</td>	
								</tr>
								...
								<tr>
									<td><?php if ($rs_data[0]["informasi_lain"]!="") { echo '13'; }else { echo '12';}?>.</td><td>Tarif pengiriman barang dapat ditinjau kembali jika terjadi perubahan kebijakan pemerintah (UMK, Harga BBM, Tarif Tol, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Standarisasi Kapasitas Muatan Kendaraan / ODOL)</td>
								</tr>
					...
					<table border=0 width=100% class="">
							...
							<tr><td align="center">&nbsp;</td></tr>
							<tr><td align="center">&nbsp;</td></tr>
							<tr><td align="center"><?php echo ($rs_data[0]["nama_sales"]); ?></td><td align="center">Yovi Reynold</td><td></td></tr>
							<tr><td align="center"><?php echo ($rs_data[0]["keterangan"]); ?></td><td align="center">Business & Development Director</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="center">(.................................................)</td></tr>
