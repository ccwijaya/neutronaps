								...
								<div class="row">
									...
									<div class="col-sm-7 infobox-container">
										...
										<div class="infobox infobox-red">
											...
											<!-- <div class="infobox-data">
											<?php //foreach($rs_ots_inq as $rs_ots_inq_cust) { ?>
												<span class="infobox-data-number"><?php //echo $rs_ots_inq_cust['total_ots_inq']; ?></span>
											<?php //}?>
												<div class="infobox-content">INQ Pending</div>
											</div> -->
										</div>

										<!-- <div class="infobox infobox-orange">
											<div class="infobox-progress">
											<?php //foreach($rs_ots_so as $rs_ots_so_cust) {  
												//$persentase_so = $rs_ots_so_cust['total_so_close'] / $rs_ots_so_cust['total_so'] * 100;
											?>
												<div class="easy-pie-chart percentage" data-percent="<?php //echo $persentase_so; ?>" data-size="46">
													<span class="percent"><?php //echo format_number($persentase_so,0); ?></span>%
												</div>
											</div>

											<div class="infobox-data">
												<span class="infobox-text"><?php //echo $rs_ots_so_cust['total_ots_so']; ?> OTS SO</span>

												<div class="infobox-content">
													<span class="bigger-110">~</span>
													<?php //echo $rs_ots_so_cust['total_so']; ?> Total SO
												</div>
											</div>
										</div>
                    					<?php //}?> -->
										...
										<!-- <div class="infobox infobox-blue2">
											<div class="infobox-progress">
											<?php //foreach($rs_ots_po_vendor as $rs_ots_po) {  
												//$persentase_po = $rs_ots_po['total_po_close'] / $rs_ots_po['total_po'] * 100;
											?>
												<div class="easy-pie-chart percentage" data-percent="<?php //echo $persentase_po; ?>" data-size="46">
													<span class="percent"><?php //echo format_number($persentase_po,0); ?></span>%
												</div>
											</div>

											<div class="infobox-data">
												<span class="infobox-text"><?php// echo $rs_ots_po['total_ots_po']; ?> OTS PO</span>

												<div class="infobox-content">
													<span class="bigger-110">~</span>
													<?php //echo $rs_ots_po['total_po']; ?> Total PO
												</div>
											</div>
										</div>
                    					<?php //}?> -->
			 ...
			 */
			 ...
			 placeholder.data('draw', drawPieChart);
			  ...
			  placeholder.on('plothover', function (event, pos, item) {
				...
				var sales_charts = $('#bar-charts').css({'width':'100%' , 'height':'220px'});
				$.plot("#bar-charts", [
