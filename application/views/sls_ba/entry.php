...
if($results != ""){							
	foreach($results as $result){
		$id = $result["id"];
		$id_po_customer = $result["id_po_customer"];
		...
		$no_container = $result["no_container"];
		$tujuan = $result["tujuan"];
		$jenis_container = $result["jenis_container"];
		$tempat_fumigasi = $result["tempat_fumigasi"];
		$waktu_pelepasan = $result["waktu_pelepasan"];
		$durasi_fumigasi = $result["durasi_fumigasi"];
		$fumigasi_digunakan = $result["fumigasi_digunakan"];
		$dosis_fumigasi = $result["dosis_fumigasi"];
									...
									<div class="tabbable">
										...
										<div id="tab1" class="tab-pane fade in active">
												<div class="col-md-offset-2">
													...
													echo'<div class="row">';
													echo'<div class="col-xs-12 col-sm-3">';
													echo '<label>No. PO Customer</label>';
													$param["name"] = "id_po_customer";
													//$param["class_column"] = "col-lg-5";
													$param["placeholder"] = "--Pilih Quotation--";
													$param["required"] = "Y";
													$param["value"] = $id_po_customer;
													$options["0"] = "--Pilih PO Customer--";
													foreach ($rs_po_customer as $data) {
													...
													echo '<label>No Container</label>';
													$param["name"] = "no_container";
													//$param["class_column"] = "col-xs-12";
													$param["required"] = "Y";
													$param["value"] = $no_container;
													echo textbox($param);
													unset($param);
													echo '</div>';

													echo'<div class="col-xs-12 col-sm-5">';
													echo '<label>Tujuan</label>';
													$param["name"] = "tujuan";
													$param["class_column"] = "col-xs-12";
													$param["required"] = "Y";
													$param["value"] = $tujuan;
													...
													echo'<div class="row">';
													echo'<div class="col-xs-12 col-sm-4">';
													echo '<label>Jenis Container</label>';
													$param["name"] = "jenis_container";
													//$param["class_column"] = "col-xs-12";
													$param["required"] = "Y";
													$param["value"] = $jenis_container;
													echo textbox($param);
													unset($param);
													echo '</div>';
													...
													echo'<div class="col-xs-12 col-sm-5">';
													echo '<label>Tempat Fumigasi</label>';
													$param["name"] = "tempat_fumigasi";
													$param["class_column"] = "col-xs-12";
													$param["required"] = "";
													$param["value"] = $tempat_fumigasi;
													echo textbox($param);
													unset($param);
													echo '</div>';
													echo '</div>';
													...
													echo'<div class="row">';
													echo'<div class="col-xs-12 col-sm-4">';
													echo '<label>Waktu Pelepasan Fumigasi</label>';
													$param["name"] = "waktu_pelepasan";
													//$param["class_column"] = "col-xs-12";
													$param["required"] = "Y";
													$param["value"] = $waktu_pelepasan;
													echo textbox($param);
													unset($param);
													echo '</div>';

													echo'<div class="col-xs-12 col-sm-3">';
													echo '<label>Durasi Fumigasi</label>';
													$param["name"] = "durasi_fumigasi";
													//$param["class_column"] = "col-xs-12";
													$param["required"] = "Y";
													$param["value"] = $durasi_fumigasi;
													echo textbox($param);
													unset($param);
													echo '</div>';
													
													echo'<div class="col-xs-12 col-sm-2">';
													echo '<label>Dosis Fumigasi</label>';
													$param["name"] = "dosis_fumigasi";
													//$param["class_column"] = "col-xs-12";
													$param["required"] = "Y";
													$param["value"] = $dosis_fumigasi;
													echo textbox($param);
													unset($param);
													echo '</div>';
													echo '</div>';
													...
													echo'<div class="row">';
													echo'<div class="col-xs-12 col-sm-3">';
													echo '<label>Fumigasi digunakan</label>';
...
$(document).ready(function(){
	...
	$("#id_po_customer").chosen().change(function(){
		$(this).find('option:selected').each(function(){
			...
			$.ajax({
				type: "GET",
				async: false,
				url: "<?php echo base_url(); ?>" + "sls_ba/get_po_detail_by_id",			
				data: {id: id},
				dataType: 'json',
	...
	$("#id_customer").chosen().change(function(){
		$(this).find('option:selected').each(function(){
			...
			$.ajax({
				type: "GET",
				async: false,
				url: "<?php echo base_url(); ?>" + "/sls_ba/get_pelanggan_by_id",			
				data: {id: id},
				dataType: 'json',
				success: function(res) {
					console.log("RES : " + res);
...
function change_combo_produk_jasa_detail(xcounter){
	...
	$.ajax({
		type: "GET",
		async: false,
		url: "<?php echo base_url(); ?>" + "sls_ba/get_produk_jasa_detail_by_id",			
