<?php
class M_sls_paf extends CI_Model {
	...
	public function get_data($id=""){
		...
		$this->db->where("a.status_pai<>", "HOLD");
	...
	public function get_rute(){
		...
		$this->db->select ( "a.id, CONCAT(a.rute,' | ',a.pool,' | ',b.unit,' ',a.tipe_box,' | ',a.nama_kategori) as nama" );
	...
	public function get_detail_tarif_kirim($id){
		$this->db->select ( 'a.*, b.rute, b.rute_pool, b.unit, b.rute, c.unit' );
