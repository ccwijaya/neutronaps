<?php
class M_sls_quotation_non extends CI_Model {
	...
	public function get_detail_pnl($id){
		$this->db->select ( "a.*, b.loading, CONCAT(b.rute,' | ',b.unit,' ', b.tipe_box,' | ', b.nama_kategori) as rute" );
		$this->db->from("sls_quotation_detail a");
		$this->db->join('view_rute_moda b', 'a.id_rute = b.id', 'left');
	...
	public function get_detail($id){
		$this->db->select ( 'a.*, c.loading, c.unloading, f.unit, c.tipe_box, e.nama_user, g.nama_customer' );
		$this->db->from("sls_quotation_detail a");
