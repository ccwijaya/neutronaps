...
class M_salesman extends CI_Model {
	...
	public function get_notif_quote_branch($id=""){
		...
		$this->db->select ( 'a.*, sum(a.ready_quote_branch) as notif, sum(d.ready_quote_branch) as notif_done' );
		...
		$this->db->where("a.ready_quote_branch", 1);
	...
	public function get_notif_quote_spot($id=""){
		...
		$this->db->select ( 'a.*, sum(a.ready_quote_spot) as notif, sum(d.ready_quote_spot) as notif_done' );
		$this->db->from('sls_terjemahan_part a');
		$this->db->join('sls_pelanggan b', 'a.id_customer = b.id', 'left');
		$this->db->join('inv_inq c', 'c.id_sales_tech = a.id', 'left');		
		if($id!=""){
		...
		$this->db->where("a.ready_quote_spot", 1);
	...
	public function get_notif_quote_interco($id=""){
		...
		$this->db->select ( 'a.*, sum(a.ready_quote_interco) as notif, sum(d.ready_quote_interco) as notif_done' );
		$this->db->from('sls_terjemahan_part a');
		$this->db->join('sls_pelanggan b', 'a.id_customer = b.id', 'left');
		$this->db->join('inv_inq c', 'c.id_sales_tech = a.id', 'left');		
		if($id!=""){
		...
		$this->db->where("a.ready_quote_interco", 1);
	...
	public function get_notif_quote_retail($id=""){
		...
		$this->db->select ( 'a.*, sum(a.ready_quote_retail) as notif, sum(d.ready_quote_retail) as notif_done' );
		$this->db->from('sls_terjemahan_part a');
		$this->db->join('sls_pelanggan b', 'a.id_customer = b.id', 'left');
		$this->db->join('inv_inq c', 'c.id_sales_tech = a.id', 'left');		
		if($id!=""){
		...
		$this->db->where("a.ready_quote_retail", 1);
    ...
    public function delete_data($id){
		$this->db->where('id', $id);
        $result = $this->db->delete($this->table_master_name);
