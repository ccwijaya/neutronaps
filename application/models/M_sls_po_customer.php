<?php
class M_sls_po_customer extends CI_Model {
	private $main_table = "sls_po_customer";
	...
	public function get_detail_rr($id){
		...
		$this->db->where("a.id_po_customer", $id);
	...
	public function get_detail($id){
		...
		$this->db->from("sls_po_customer_detail a");
		$this->db->join('sls_po_customer b', 'a.id_po_customer = b.id', 'left');
	...
	public function simpan_data_detail($data, &$id = ""){
		...
		$result = $this->db->insert("sls_po_customer_detail", $data);
		$id = $this->db->insert_id();
	...
	public function reset_data($id){
		$this->db->where('id_po_customer', $id);
        $result = $this->db->delete("sls_po_customer_detail");
