<?php
class M_acc_pog extends CI_Model {
	...
	public function get_data($id=""){
		...
		$this->db->where("a.attach_quote_app <>", NULL);
		if($id!=""){
	...
	public function get_detail_grv($id){
		...
		$this->db->select ( 'a.*, b.transporter, b.grade, b.moda, b.tipe_box, b.pool, b.area, b.vol_ton, b.vol_trip, b.rute_grv' );
