<?php
class M_ops_verif_paf extends CI_Model {
	...
	public function get_detail_tarif_kirim($id){
		$this->db->select ( 'a.*, b.id_cost_tol, b.rute, b.loading' );
		$this->db->from("view_rute_paf_date_plus3 a");
		$this->db->join('view_rute_all b', 'b.id = a.rute_tarif', 'left');
		//$this->db->where("a.post_date <=3 ");
		$this->db->where("a.id_paf", $id);
