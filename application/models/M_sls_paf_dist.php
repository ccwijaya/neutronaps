<?php
class M_sls_paf_dist extends CI_Model {
	...
	public function get_rute(){
		...
		$this->db->select ( "a.id, CONCAT(a.kode_dist,' | ',a.dop_start,' - ',a.dop_end) as nama" );
	...
	public function get_detail($id){
		...
		$this->db->join('dist_rute b', 'a.id_rute_dist = b.id', 'left');
	...
	public function get_detail_tarif_kirim($id){
		$this->db->select ( 'a.*, b.kode_dist, b.dop_start, b.dop_end, b.rute, b.unit, c.unit' );
		$this->db->from("sls_paf_tarif_kirim a");
		$this->db->join('view_dist_rute b', 'b.id = a.rute_tarif', 'left');
