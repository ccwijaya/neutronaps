<?php
class M_kategori_kirim_dist extends CI_Model {
	private $main_table = "kategori_kirim_dist";
	
	public function get_data($id=""){
		$this->db->select ( 'a.*,b.no_bukti, b.periode, b.ket' );
		$this->db->from($this->main_table . " a");
		$this->db->join('biaya_ops b', 'a.id_ops = b.id', 'left');
