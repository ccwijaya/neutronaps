<?php
class M_sls_rate_request_non extends CI_Model {
	...
	public function get_detail($id){
		$this->db->select ( 'a.*, c.rute, c.loading, c.unloading, f.unit, c.tipe_box, e.nama_user, e.ttd, b.nama_approved, b.ttd_approved, g.nama_customer' );
		$this->db->from("sls_rate_request_detail a");
